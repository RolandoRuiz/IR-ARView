...
function forceCloseDropdown(){
  ...
  if(Sh1.style.display !== "flex"){
    ...
    BackImg.style.backgroundImage = "url(/imprey/img/Categories/CategoryWearables.jpg)";
  }
}
...
function showSh2(){
  ...
  BackImg.style.backgroundImage = "url(/imprey/img/Categories/Test.jpg)";
}
...
function showSh3(){
  ...
  Sh1.style.animationDuration = '1s';
  Sh1.style.animationTimingFunction = 'ease-in-out';
  BackImg.style.backgroundImage = "url(/imprey/img/Categories/CategoryMetals.jpg)";
}
...
function showSh4(){
  ...
  Sh1.style.animationDuration = '1s';
  Sh1.style.animationTimingFunction = 'ease-in-out';
  BackImg.style.backgroundImage = "url(/imprey/img/OurLocation.jpg)";
}
